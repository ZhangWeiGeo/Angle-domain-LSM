...
sort_angle_list=[5, 15, 25, 35, 45, 55, 65, 75, 85]; ##true_angle=inv_angle_start + 5*dangle; ##
#5, 15, 25, 35, 45, 55, 65, 75, 85

###################
###################
iter_num=124
iter_num_arr=(124, 248)
    ...
    for ix in range(0, len(vertical_sort_x_list)):
        ...
        if sort_x < nx:
            ...
            for ig_id in range(0, len(sort_angle_list)):
                ...
                name1        = "CC-KM, NCC={:.3f}".format(cc1)
                name2        = "CC-IDLSM, NCC={:.3f}".format(cc2)    
